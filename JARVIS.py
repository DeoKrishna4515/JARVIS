...
def dict():
    ...
    if 'meaning' in query:
        ...
        mean = Diction.meaning(query)
        print(f"The meaning of {query} is {mean}")
        speak(f"The meaning of {query} is {mean}")
    ...
    if 'antonym' in query:
        ...
        anto = Diction.meaning(query)
        print(f"The meaning of {query} is {anto}")
        speak(f"The meaning of {query} is {anto}")
    ...
    if 'synonym' in query:
        ...
        sy = Diction.meaning(query)
        print(f"The meaning of {query} is {sy}")
        speak(f"The meaning of {query} is {sy}")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'alarm' in query:
            ...
            query = query.replace("canyouaningof","")
            query = query.replace("canyouaning","")
            query = query.replace("aning","")
            print(query)
            mean = Diction.meaning(query)
            print(f"The meaning of {query} is {mean}")
            speak(f"The meaning of {query} is {mean}")
        ...
        elif 'score' in query or 'ipl' in query or 'cricket' in query:
            ...
            print(f'Searching {query} in wikipedia')
